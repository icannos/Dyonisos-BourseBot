...
class App():
    ...
    def __init__(self):
        ...
        GlobalFile.init_Loader()
        loader = GlobalFile.get_Loader()
        logging.info("================= Loading settings ================")
        GlobalFile.load_config()
        self.conf = GlobalFile.get_config()
        logging.info("================= Loading Firms ================")
        GlobalFile.load_firms()
        self.firms = GlobalFile.get_firms()
        logging.info("================= Loading modules ================")
        GlobalFile.load_modules()
        self.modules = GlobalFile.get_modules()
